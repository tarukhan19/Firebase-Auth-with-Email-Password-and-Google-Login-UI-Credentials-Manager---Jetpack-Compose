...
@Singleton
class DataStoreAuthPreferencesImpl @Inject constructor(private val dataStore: DataStore<Preferences>) :
    ...
    override val getLoginState: Flow<Boolean> = dataStore.data
        .map { preferences ->
