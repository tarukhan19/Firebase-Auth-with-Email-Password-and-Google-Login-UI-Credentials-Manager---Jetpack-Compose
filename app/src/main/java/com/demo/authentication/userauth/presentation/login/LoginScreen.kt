...
fun LoginScreenRoot(
    ...
    val loginResultFlow = remember {
        loginViewModel.loginState
            .map { it.loginResult }.distinctUntilChanged()
    }
    ...
    ObserveAsEvents(loginResultFlow) {
        it?.let { response ->
            when (response) {
    ...
    ScaffoldUi(showToolBar = false) {
        ...
        CustomTextFieldForm(
            ...
            Modifier
                ...
                .padding(all = 5.dp),
            singleLine = true,
            isError = !loginState.emailIdError.isNullOrEmpty(),
            keyboardOptions =
            KeyboardOptions(
